...
def register_dev_tools(mcp):
  ...
  async def get_dev_list(
    ...
    dmNum = 110
    para = [dept, devdes]
    return await get_ai_result(dmCode, dmNum, para, userid)
  ...
  async def dev_mnt_reg(
    ...
    return await ai_action(dmCode, dmNum, action, para, rowdata, userid)
  ...
  async def dev_mnt_complete(
    ...
    return await ai_row_submit(dmCode, dmNum, scriptType, para, rowdata, userid)